...
public class EditBooks extends javax.swing.JFrame {
    ...
    public EditBooks() {
        initComponents();
        setDefaultCloseOperation(EditBooks.DISPOSE_ON_CLOSE);
    }
    ...
    private void initComponents() {
        ...
        cBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "BOOK_ID", "CATEGORY", "NAME", "AUTHOR", "COPIES" }));
        ...
        jLabel4.setText("ENTER BOOK ID / NAME :");
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        ...
        String query = "update books set " + choice + " = '" + newdata + "' where book_id = '"+input+"' or name = '"+input+"';";
        try {
