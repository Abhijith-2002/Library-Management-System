...
public class EditStaff extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("EDIT STAFFS");

        jLabel2.setText("EDIT :");

        cBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "STAFF_ID", "NAME", "CONTACT" }));
        ...
        jLabel4.setText("ENTER STAFF ID / NAME :");
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        ...
        String query = "update staffs set " + choice + " = '" + newdata + "' where staff_id = '"+input+"' or name = '"+input+"';";
        try {
