...
public class EditReader extends javax.swing.JFrame {
    ...
    public EditReader() {
        initComponents();
        setDefaultCloseOperation(EditReader.DISPOSE_ON_CLOSE);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("EDIT READERS");

        jLabel2.setText("EDIT :");

        cBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "READER_ID", "NAME", "CONTACT" }));
        ...
        jLabel4.setText("ENTER READER ID / NAME :");
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        ...
        String query = "update readers set " + choice + " = '" + newdata + "' where reader_id = '"+input+"' or name = '"+input+"';";
        try {
